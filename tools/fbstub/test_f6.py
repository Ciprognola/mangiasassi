...
with sync_playwright() as pw:
    ...
    if bugs:
        d = bugs[0]
        check("field values", d["uid"] == "uid_master" and d["text"] == "il menu ha un problema" and d["screen"] == "menu-home-roccia" and d["version"] == "0.4_4" and d["char"] == "roccia" and d["ts"] == {"__ts": True} and 0 < len(d["ua"]) <= 300, d)
